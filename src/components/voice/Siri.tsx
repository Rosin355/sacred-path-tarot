...
type SiriVariant = 'default' | 'compact';
...
export default function Siri({ state, visualState, analyser, onClick, variant = 'default' }: SiriProps) {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`voice-siri-preview${isCompact ? ' voice-siri-preview--compact' : ''}`}
