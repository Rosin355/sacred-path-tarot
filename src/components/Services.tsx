...
const Services = () => {
  ...
  return <section id="services-section" className="py-32 lg:py-40 px-6 lg:px-12 relative">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service, index) => <Card key={index} className="minimal-border bg-card/30 backdrop-blur-sm hover-lift animate-fade-in" style={{
          animationDelay: `${0.2 + index * 0.1}s`
        }}>
              <CardContent className="p-8 space-y-6">
                {/* Immagine placeholder */}
                <div className="relative overflow-hidden minimal-border aspect-square">
                  <img src="/placeholder.svg" alt={service.alt} className="w-full h-full object-cover opacity-70" />
                ...
                <div className="text-center space-y-4">
                  ...
                  <h3 className="font-heading3 text-4xl">
                    {service.title}
                  </h3>
