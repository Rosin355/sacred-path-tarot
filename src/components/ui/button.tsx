  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "minimal-border bg-transparent hover:bg-card/50 hover:text-foreground",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "hover:bg-card/50 hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        glow: "bg-accent text-accent-foreground hover:bg-accent/90 border border-accent/30 hover:shadow-[0_0_30px_hsla(var(--accent)/0.5),0_0_60px_hsla(var(--accent)/0.3)] transition-shadow duration-300",
      },
      size: {
