...
const Journey = () => {
  ...
  return <section id="journey-section" className="py-32 lg:py-40 px-6 lg:px-12 relative">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {levels.map((level, index) => <Card key={index} className="bg-transparent minimal-border hover-lift group cursor-pointer animate-scale-in" style={{
          animationDelay: `${index * 0.15}s`
              ...
              <CardHeader className="space-y-6 p-8">
                ...
                <div>
                  ...
                  <CardTitle className="font-display tracking-tight text-5xl font-normal">
                    {level.title}
                  </CardTitle>
                </div>
              </CardHeader>
              ...
              <CardContent className="space-y-6 p-8 pt-0">
                <CardDescription className="leading-relaxed text-muted-foreground font-light text-lg">
                  {level.description}
                </CardDescription>
                
                <div className="pt-6 border-t border-border space-y-4">
                  <p className="text-muted-foreground font-light text-base">{level.lessons}</p>
                  <Button onClick={playNavigation} className="w-full group/btn" variant={index === 0 ? "default" : "outline"}>
